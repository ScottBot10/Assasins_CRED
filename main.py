...
school = from_csv(f"./{test_resources}/grade 8.csv")
pprint.pprint(school)

write_people(school, f"./{test_resources}/people.csv")

shuff = shuffle_school_grade(school)
pprint.pprint(shuff)

write_people(shuff, f"./{test_resources}/people.csv")

school = read_people(f"./{test_resources}/people.csv")
pprint.pprint(school)
